...
<body>
    ...
    <div class="story-layout">
        ...
        <div class="story-text-column">
            ...
            <div class="text-block reveal-text">
                <p>Detaylı CPU değişim videoları için aşağıdaki linklere bakabilirsiniz. Laptop işlemcileri yeni nesil laptop'larda anakarta lehimli olduğu için değiştirilmesi için anakart değiştirilmeli ya da özel cihazlarla lehimler eritilerek işlemci değiştirilir.</p>
                <br><br>
                <p style="background-color: black;"><a href="https://www.youtube.com/watch?v=MEHdOPRD0UQ"><b>Kasalarda İşlemci Değişimi Videosu İçin Tıklayınız</b></a></p>
                <br><br>
                <p style="background-color: black;"><a href="https://www.youtube.com/watch?v=v4Q-3-leDhQ"><b>Laptop İşlemci Değişimi Videosu İçin Tıklayınız (Eğer siz yapacaksanız öncelikle Laptop'unuzun markasına ve modeline göre video arayınız. Bu video genel bir örnektir.)</b></a></p>
            </div>
