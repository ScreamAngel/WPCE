...
<div class="cards">
        ...
        Marka-Model: <font color="#FFFFFF">ASUS TUF F16 FX608JH-RV010</font><br>
        İşlemci: <font color="#FFFFFF">Intel Core i5-13450HX</font><br>
        GHZ-Temel/Turbo: <font color="#FFFFFF">2.4GHZ/4.6GHZ</font><br>
        Ekran Kartı: <font color="#FFFFFF">NVIDIA Geforce RTX 5050 Laptop GPU</font><br>
        ...
        <br>
    <a href="https://www.mediamarkt.com.tr/tr/product/_asus-tuf-f16-fx608jh-rv010-gaming-rtx-5050-fhd-165hz-ips-intel-core-i5-13450hx-16-gb-ram-512-gb-ssd-16-inc-freedos-gaming-laptop-gri-165528363.html"><button class="magaza">Mağaza Sayfasını Gör</button></a><br>
...
I use Arch btw.`, "color: #1793d1; font-weight: bold;");
    ...
    const fpsData = [
      ...
      { game: "Resident Evil Requiem", resolution: "1080p", fps: 85 },
      { game: "Resident Evil Requiem", resolution: "1440p", fps: 60 },
      { game: "Resident Evil Requiem", resolution: "4K", fps: 30 },

      // Red Dead Redemption 2
      { game: "Red Dead Redemption 2", resolution: "1080p", fps: 70 },
      { game: "Red Dead Redemption 2", resolution: "1440p", fps: 51 },
      { game: "Red Dead Redemption 2", resolution: "4K", fps: 24 },

      // Cyberpunk 2077
      { game: "Cyberpunk 2077", resolution: "1080p", fps: 70 },
      { game: "Cyberpunk 2077", resolution: "1440p", fps: 45 },
      { game: "Cyberpunk 2077", resolution: "4K", fps: 21 }
    ];
