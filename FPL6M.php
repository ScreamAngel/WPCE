...
<div class="cards">
        ...
        Marka-Model: <font color="#FFFFFF">ACER PHN16-72</font><br>
        İşlemci: <font color="#FFFFFF">Core i7-14650HX</font><br>
        GHZ-Temel/Turbo: <font color="#FFFFFF">2.2GHZ/4.6GHZ</font><br>
        ...
        <br>
    <a href="https://www.mediamarkt.com.tr/tr/product/_acer-phn16-72core-i7-14650hx16-gb-ram1-tb-ssdrtx406016w11nhqqvey002-laptop-1244673.html"><button class="magaza">Mağaza Sayfasını Gör</button></a><br>
...
I use Arch btw.`, "color: #1793d1; font-weight: bold;");
    ...
    const fpsData = [
      ...
      { game: "Resident Evil Requiem", resolution: "1080p", fps: 84 },
      { game: "Resident Evil Requiem", resolution: "1440p", fps: 60 },
      { game: "Resident Evil Requiem", resolution: "4K", fps: 30 },

      // Red Dead Redemption 2
      { game: "Red Dead Redemption 2", resolution: "1080p", fps: 75 },
      { game: "Red Dead Redemption 2", resolution: "1440p", fps: 55 },
      { game: "Red Dead Redemption 2", resolution: "4K", fps: 28 },

      // Cyberpunk 2077
      { game: "Cyberpunk 2077", resolution: "1080p", fps: 73 },
      { game: "Cyberpunk 2077", resolution: "1440p", fps: 50 },
      { game: "Cyberpunk 2077", resolution: "4K", fps: 22 }
    ];
