...
<div class="cards">
        ...
        Marka-Model: <font color="#FFFFFF">MSI Cyborg 15 A13VF-893XTR</font><br>
        İşlemci: <font color="#FFFFFF">Intel Core i7 13620H</font><br>
        GHZ-Temel/Turbo: <font color="#FFFFFF">3.6GHZ/4.9GHZ</font><br>
        Ekran Kartı: <font color="#FFFFFF">NVIDIA Geforce RTX 4060 Laptop GPU</font><br>
        ...
        <br>
    <a href="https://www.mediamarkt.com.tr/tr/product/_msi-cyborg-15-a13vf-893xtr-intel-core-i7-13620h-16-gb-ram-512-gb-ssd-geforce-rtxtm-4060-156-inc-freedos-gaming-laptop-koyu-gri-162143940.html"><button class="magaza">Mağaza Sayfasını Gör</button></a><br>
...
I use Arch btw.`, "color: #1793d1; font-weight: bold;");
    ...
    const fpsData = [
      ...
      { game: "Resident Evil Requiem", resolution: "1080p", fps: 81 },
      { game: "Resident Evil Requiem", resolution: "1440p", fps: 60 },
      { game: "Resident Evil Requiem", resolution: "4K", fps: 27 },

      // Red Dead Redemption 2
      { game: "Red Dead Redemption 2", resolution: "1080p", fps: 73 },
      { game: "Red Dead Redemption 2", resolution: "1440p", fps: 53 },
      { game: "Red Dead Redemption 2", resolution: "4K", fps: 25 },

      // Cyberpunk 2077
      { game: "Cyberpunk 2077", resolution: "1080p", fps: 70 },
      { game: "Cyberpunk 2077", resolution: "1440p", fps: 45 },
      { game: "Cyberpunk 2077", resolution: "4K", fps: 20 }
    ];
