...
<div class="cards">
        ...
        Marka-Model: <font color="#FFFFFF">ASUS TUF F16 FX607VU-RL073W</font><br>
        İşlemci: <font color="#FFFFFF">AMD Ryzen 7 7445HS</font><br>
        GHZ-Temel/Turbo: <font color="#FFFFFF">3.2GHZ/4.7GHZ</font><br>
        Ekran Kartı: <font color="#FFFFFF">NVIDIA Geforce RTX 4050 Laptop GPU</font><br>
        ...
        <br>
    <a href="https://www.mediamarkt.com.tr/tr/product/_asus-tuf-a16-fa607nug-rl125-gaming-fhd-amd-ryzen-7-7445hs-16-gb-ram-512-gb-ssd-16-inc-freedos-gaming-laptop-siyah-168879015.html"><button class="magaza">Mağaza Sayfasını Gör</button></a><br>
  ...
  <div id="fps-container"></div>
    ...
    <br>
     <center><a href="FPM.php"><button class="don">Geri Dön</button></a><center>
...
I use Arch btw.`, "color: #1793d1; font-weight: bold;");
    ...
    // --- FPS Verileri (İntel Core 5 - 210H + RTX 4050 Laptop GPU) ---
    const fpsData = [
      // Resident Evil Requiem
      { game: "Resident Evil Requiem", resolution: "1080p", fps: 60 },
      { game: "Resident Evil Requiem", resolution: "1440p", fps: 36 },
      { game: "Resident Evil Requiem", resolution: "4K", fps: 13 },

      // Red Dead Redemption 2
      { game: "Red Dead Redemption 2", resolution: "1080p", fps: 56 },
      { game: "Red Dead Redemption 2", resolution: "1440p", fps: 33 },
      { game: "Red Dead Redemption 2", resolution: "4K", fps: 17 },

      // Cyberpunk 2077
      { game: "Cyberpunk 2077", resolution: "1080p", fps: 53 },
      { game: "Cyberpunk 2077", resolution: "1440p", fps: 27 },
      { game: "Cyberpunk 2077", resolution: "4K", fps: 11 }
    ];
    ...
    function loadFPS() {
      ...
      //Yapılan filtreyi veya matematik hesabını tutan yer
      results.forEach(r => {
