...
<body>
    ...
    <br><br><br><br><br><br><br>
      <div class="grid-container">
        <a href="https://www.youtube.com/watch?v=fXVy4mALHLY" target="_blank" rel="noopener noreferrer">
        ...
        <a href="Kasa2.php">
        <div class="resim-karti">
          <img src="Tavsiye Sistem.jpg" alt="Aksiyon">
          <div class="hover-bilgi">
            <h3>ASUS ROG G700 GM700TZ-R9700X0430<br>AMD Ryzen 7-9700X / 16GB RAM<br>1TB SSD / RX 9070 XT OC 16GB<br>850W 80+ Gold / FreeDos Gaming Masaüstü<br><h2>86.999 TL</h2></h3>
          </div>
          </div>
          </a>
    ...
    <br>
     <center><a href="sistem.php"><button class="don">Geri Dön</button></a></center>
<br>
<br>
<br>
<br>
