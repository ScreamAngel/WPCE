...
<section id="story" class="story-container">
    <div class="story-layout">
        ...
        <div class="story-text-column">
            ...
            <div class="text-block reveal-text">
                <p>Detaylı GPU değişim videoları için aşağıdaki linke bakabilirsiniz. Laptop GPU'ları anakarta lehimli olduğu için değiştirilmesi için anakart değiştirilmeli ya da özel cihazlarla lehimler eritilerek GPU değiştirilir. Çok nadir laptop'larda GPU soketi olduğu için o laptop'larda GPU değiştirilebilir.</p>
                <br><br>
                <p style="background-color: black;"><a href="https://www.youtube.com/watch?v=bE4gD1FkIA8"><b>Kasalarda GPU Değişimi Videosu İçin Tıklayınız</b></a></p>
            </div>
