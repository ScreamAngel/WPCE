...
<section id="story" class="story-container">
    <div class="story-layout">
        ...
        <div class="story-text-column">
            <h2 class="reveal-text">Story</h2>
            
            <div class="text-block reveal-text">
                <p>A body has surfaced at an abandoned hotel in the Midwest, the latest in a mysterious string of deaths throughout the United States.</p>
            </div>
            
            <div class="text-block reveal-text">
                <p>FBI intelligence analyst Grace Ashcroft has been assigned to the case—in the same place where her mother was murdered eight years prior.</p>
            </div>

            <div class="text-block reveal-text">
                <p>As Grace and Leon's paths converge, they must face their pasts and uncover the truth behind the Raccoon City Incident.</p>
            </div>
        </div>
        ...
        <div class="story-image-column">
            <div class="sticky-image-wrapper">
                <div class="image-frame">
                    <img src="re4.jpg" alt="Leon Kennedy">
...
async function startArchSequence() {
    ...
    window.location.href = "arch_rehber.php";
}
